  ...
  return (
    <footer className="mt-24 bg-petrol-deep text-white/70">
      <div className="mx-auto grid w-full max-w-6xl gap-10 px-5 py-16 sm:px-8 md:grid-cols-4">
        ...
        <div>
          <h4 className="font-serif text-lg font-semibold text-white">Kurumsal</h4>
        ...
        <div>
          <h4 className="font-serif text-lg font-semibold text-white">Kategoriler</h4>
          <ul className="mt-4 space-y-2.5 text-sm">
        ...
        <div>
          <h4 className="font-serif text-lg font-semibold text-white">İletişim</h4>
          <ul className="mt-4 space-y-3.5 text-sm">
            ...
            <li>
              <a
                ...
                className="mt-1 inline-flex items-center gap-2 rounded-full border border-gold/50 px-4 py-2 font-medium text-gold transition hover:bg-gold hover:text-white"
              >
